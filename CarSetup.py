...
def Tire_Objects():
	...
	# tire names
	frontDriver    = "ruedaDC"  # front driver's tire 
	frontPassenger = "ruedaDP"  # front passenger's tire 
	rearDriver     = "ruedaTC"  # rear driver's tire
	rearPassenger  = "ruedaTP"  # rear passenger's tire
