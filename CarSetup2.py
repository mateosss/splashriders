...
def Tire_Objects():
	...
	# tire names
	frontDriver    = "ruedaDC2"  # front driver's tire 
	frontPassenger = "ruedaDP2"  # front passenger's tire 
	rearDriver     = "ruedaTC2"  # rear driver's tire
	rearPassenger  = "ruedaTP2"  # rear passenger's tire
...
def Tire_Positions():
	...
	# tire position
	tire_0_Pos = [ -0.3,0.45,  -0]  # front driver's tire 
	tire_1_Pos = [  0.3,0.45,  -0]  # front passenger's tire 
	tire_2_Pos = [ -0.3,-0.7,  -0]  # rear driver's tire 
	tire_3_Pos = [  0.3,-0.7,  -0]  # rear passenger's tire 
...
def Tire_Radius():
	...
	# tire radius
	tire_0_Radius = 0.30   # front driver's tire 
	tire_1_Radius = 0.30   # front passenger's tire 
	tire_2_Radius = 0.30   # rear driver's tire 
	tire_3_Radius = 0.30   # rear passenger's tire 
...
def Tire_Suspension():
	...
	# tire suspension height
	tire_0_suspensionHeight = 0.1   # front driver's tire 
	tire_1_suspensionHeight = 0.1   # front passenger's tire 
	tire_2_suspensionHeight = 0.1   # rear driver's tire 
	tire_3_suspensionHeight = 0.1   # rear passenger's tire 
