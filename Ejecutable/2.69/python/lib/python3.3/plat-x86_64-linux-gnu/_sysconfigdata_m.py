...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'AR': 'ar',
 'ARFLAGS': 'rc',
 'ASDLGEN': 'python3.3 ../Parser/asdl_c.py',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/usr/bin',
 'BINLIBDEST': '/usr/lib/python3.3',
 'BLDLIBRARY': '-lpython3.3m',
 'BLDSHARED': 'x86_64-linux-gnu-gcc -pthread -shared -Wl,-O1 -Wl,-Bsymbolic-functions -Wl,-Bsymbolic-functions -Wl,-z,relro -Wno-unused-result -DNDEBUG -g -fwrapv -O2 -Wall -Wstrict-prototypes -g -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security  ',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -DNDEBUG -g -fwrapv -O2 -Wall -Wstrict-prototypes -g -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security  ',
 'CFLAGSFORSHARED': '-fPIC',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-g -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security',
 ...
 'CONFINCLUDEPY': '/usr/include/python3.3m',
 'COREPYTHONPATH': ':plat-x86_64-linux-gnu',
 'CPPFLAGS': '-I. -IInclude -I../Include -D_FORTIFY_SOURCE=2',
 'CXX': 'x86_64-linux-gnu-g++ -pthread',
 'DESTDIRS': '/usr /usr/lib /usr/lib/python3.3 /usr/lib/python3.3/lib-dynload',
 'DESTLIB': '/usr/lib/python3.3',
 'DESTPATH': '',
 'DESTSHARED': '/usr/lib/python3.3/lib-dynload',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/usr/include /usr/include /usr/include/python3.3m /usr/include/python3.3m',
 'INCLUDEDIR': '/usr/include',
 'INCLUDEPY': '/usr/include/python3.3m',
 'INSTALL': '/usr/bin/install -c',
 'INSTALL_DATA': '/usr/bin/install -c -m 644',
 'INSTALL_PROGRAM': '/usr/bin/install -c',
 'INSTALL_SCRIPT': '/usr/bin/install -c',
 'INSTALL_SHARED': '/usr/bin/install -c -m 555',
 'INSTSONAME': 'libpython3.3m.so.1.0',
 'IO_H': 'Modules/_io/_iomodule.h',
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'x86_64-linux-gnu-g++ -pthread -shared -Wl,-O1 -Wl,-Bsymbolic-functions',
 'LDFLAGS': '-Wl,-Bsymbolic-functions -Wl,-z,relro',
 'LDLAST': '',
 'LDLIBRARY': 'libpython3.3m.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'x86_64-linux-gnu-gcc -pthread -shared -Wl,-O1 -Wl,-Bsymbolic-functions -Wl,-Bsymbolic-functions -Wl,-z,relro -Wno-unused-result -DNDEBUG -g -fwrapv -O2 -Wall -Wstrict-prototypes -g -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security  ',
 'LDVERSION': '3.3m',
 'LIBC': '',
 'LIBDEST': '/usr/lib/python3.3',
 'LIBDIR': '/usr/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 ...
 'LIBPL': '/usr/lib/python3.3/config-3.3m-x86_64-linux-gnu',
 ...
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_CFLAGS': '-Wno-unused-result -DNDEBUG -g -fwrapv -O2 -Wall -Wstrict-prototypes -g -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security  ',
 'PY_CORE_CFLAGS': '-Wno-unused-result -DNDEBUG -g -fwrapv -O2 -Wall -Wstrict-prototypes -g -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security   -I. -IInclude -I../Include -D_FORTIFY_SOURCE=2 -fPIC -DPy_BUILD_CORE',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/buildd/python3.3-3.3.2/build-shared:',
 'SCRIPTDIR': '/usr/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/buildd/python3.3-3.3.2/build-shared: ./python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/buildd/python3.3-3.3.2/build-shared: ./python ../Tools/scripts/run_tests.py',
 'TESTTIMEOUT': 3600,
 ...
 'abs_builddir': '/build/buildd/python3.3-3.3.2/build-shared',
 'abs_srcdir': '/build/buildd/python3.3-3.3.2/build-shared/..',
